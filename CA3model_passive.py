...
def CA3model_passive_solver(params, return_trace=False):
    ...
    #sol = odeint(CA3model_passive, init_var, t, args=(f_stim_ext_s, f_stim_ext_d, gL, VL, gc, pp, Cm))
    ...
    # csak arany
    # points = [np.random.normal(s_p1/d_p1, 0.5), np.random.normal(s_p2/d_p2, 0.5),
    #         np.random.normal(s_p3/d_p3, 0.5), np.random.normal(s_p4/d_p4, 0.5)]

    # minden
    # points = [np.random.normal(s_p1, 0.5), np.random.normal(d_p1, 0.5), np.random.normal(s_p1/d_p1, 0.5),
    #               np.random.normal(s_p2, 0.5), np.random.normal(d_p2, 0.5), np.random.normal(s_p2/d_p2, 0.5),
    #               np.random.normal(s_p3, 0.5), np.random.normal(d_p3, 0.5), np.random.normal(s_p3/d_p3, 0.5),
    #               np.random.normal(s_p4, 0.5), np.random.normal(d_p4, 0.5), np.random.normal(s_p4/d_p4, 0.5)]
    #
    points = [np.random.normal(s_p1, 0.5), np.random.normal(d_p1, 0.5),
              np.random.normal(s_p2, 0.5), np.random.normal(d_p2, 0.5),
              np.random.normal(s_p3, 0.5), np.random.normal(d_p3, 0.5),
              np.random.normal(s_p4, 0.5), np.random.normal(d_p4, 0.5)]
